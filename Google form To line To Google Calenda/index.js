...
//itemResponses[11].getItem().getTitle();
function Main() {
    // Form responses
    ...
    if (startDate.getDate() === endDate.getDate()) {
        calendar.createEvent(titles, startDate, { sendInvites: true, description: description });
    } else {
...
function generateMessage(obj_Message) {
    ...
    for (var j = 0; j < 11; j++) {
     ...
     text_data += '\n File ' + 'https://drive.google.com/open?id=1vFanoVZSRJc1x-49PJc5M_O0fegFln2k'
...
function sendNotification(text) {
    var formData = {
        'message': text,
        'imageThumbnail':'https://picpost.postjung.com/data/184/184340-1-2995.jpg'
       ,'imageFullsize': 'https://picpost.postjung.com/data/184/184340-1-2995.jpg'
