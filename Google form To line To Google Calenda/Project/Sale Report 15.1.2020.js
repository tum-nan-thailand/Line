...
var starts =  new Date(startDate).toGMTString();
var end =  new Date(endDate).toGMTString();
   
  calendar.createEvent('Apollo 11 Landing',
    new Date(starts),
    new Date(end)
...
function sendNotification(text) {
    ...
    var token = 'Line ToKen'; //Token ของ Line
    var options = {
        'method': 'post',
